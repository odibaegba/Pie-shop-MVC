...
namespace SeoPieShop.Migrations
{
    ...
    [Migration("20230228232712_OderUpdated")]
    partial class OderUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeoPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("SeoPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("SeoPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SeoPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SeoPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("SeoPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("SeoPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SeoPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeoPieShop.Models.Pie", b =>
                {
                    b.HasOne("SeoPieShop.Models.Category", "Category")
                        .WithMany("Pies")
